...
for n in range(15):
    ...
    for i in inps_poss:
        ...
        sdss_mae = mlp(seed, plotting, inp, fol, sim, cat, dust, snap, redshift, cs, cs_mask, sampling, bins, count, N, scaling, h_nodes, activation, optimizer, dropout, perc_train, loss, epochs, batch_size, fluxes, colors)
        errors_arr.append(sdss_mae)
    ...
    np.save('/disks/strw9/vanweenen/mrp2/plots/feature_importance/errors_featureimportance_bottomup_sdss_'+inp+'_nodes='+str(n+1)+'.pdf', save_arr)
...
np.save('/disks/strw9/vanweenen/mrp2/plots/feature_importance/errors_featureimportance_bottomup_sdss_'+inp+'_all_.pdf', tot_save_arr)
